...
def main_evaluate(_config: dict, start_date: str, end_date: str,
    ...
    # determine which scaler to use for Smart meter scaling
    ...
    # TODO take mutliple model_folders as input and iterate over them
    ...
    for d in pd.date_range(start_date, end_date):  # could also be pass as an array of timeseries to the model.
        ...
        rescaled_predictions = scaler.inverse_transform(scaled_predictions).with_columns_renamed('gross', 'gross_predicted')
    ...
    get_metrics(ts['gross_actuals'], ts['gross_predicted'])
    ts.to_csv(f'{model_folder}/evaluation_data.csv')
...
if __name__ == "__main__":
    ...
    main_evaluate(_config=model_config, start_date='2023-07-15', end_date='2023-07-22',
